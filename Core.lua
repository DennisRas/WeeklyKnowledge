...
local WP_CATEGORY_UNIQUE = "Unique"
local WP_CATEGORY_TREATISE = "Treatise"
local WP_CATEGORY_WORKORDER = "Work Order"
...
local WP_CATEGORIES_TOOLTIPS = {
  ...
  [WP_CATEGORY_UNIQUE] = "These are one-time unique items found in treasures and sold by Acuity/Renown/Kej vendors.\n\nRepeatable: " .. WHITE_FONT_COLOR:WrapTextInColorCode("No"),
  [WP_CATEGORY_TREATISE] = "These can be crafted by inscriptors at the Crafting Order window.\n\nRepeatable: " .. WHITE_FONT_COLOR:WrapTextInColorCode("Weekly"),
  [WP_CATEGORY_WORKORDER] = "Quest: Complete a Crafting Order at your crafting bench.\n\nRepeatable: " .. WHITE_FONT_COLOR:WrapTextInColorCode("Weekly"),
  [WP_CATEGORY_TREASURE] = "These are randomly looted from treasures around the world.\n\nRepeatable: " .. WHITE_FONT_COLOR:WrapTextInColorCode("Weekly"),
  [WP_CATEGORY_GATHERING] = "These are randomly looted from gathering nodes around the world. These are also looted from Disenchanting.\n\nRepeatable: " .. WHITE_FONT_COLOR:WrapTextInColorCode("Weekly"),
  [WP_CATEGORY_TRAINER] = "Quest: Complete quests at your profession trainer.\n\nRepeatable: " .. WHITE_FONT_COLOR:WrapTextInColorCode("Weekly"),
...
local WP_DATA = {
  {
    ...
    objectives = {
      ...
      {category = WP_CATEGORY_WORKORDER, quests = {84133}, itemID = 228773, points = 2},
  ...
  },
  {
    ...
    objectives = {
      ...
      {category = WP_CATEGORY_WORKORDER, quests = {84127}, itemID = 228774, points = 2},
  ...
  },
  {
    ...
    objectives = {
      ...
      {category = WP_CATEGORY_WORKORDER, quests = {84128}, itemID = 228775, points = 1},
  ...
  },
  {
    ...
    objectives = {
      ...
      {category = WP_CATEGORY_WORKORDER, quests = {84129}, itemID = 228776, points = 2},
  ...
  },
  {
    ...
    objectives = {
      ...
      {category = WP_CATEGORY_WORKORDER, quests = {84130}, itemID = 228777, points = 2},
  ...
  },
  {
    ...
    objectives = {
      ...
      {category = WP_CATEGORY_WORKORDER, quests = {84131}, itemID = 228778, points = 2},
  ...
  },
  {
    ...
    objectives = {
      ...
      {category = WP_CATEGORY_WORKORDER, quests = {84132}, itemID = 228779, points = 2},
