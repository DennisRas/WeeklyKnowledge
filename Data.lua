...
Data.Objectives = {
  ...
  -- Midnight: Alchemy
  {skillLineVariantID = 2906, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = 238536,       points = 3,  loc = {m = Enum.WK_Map.SilvermoonCity, x = 49.1, y = 75.6, hint = "A bunch of peacebloom flowers on a crate."}},                                                                                                                                                                                                                                                                                                     -- Freshly Plucked Peacebloom Freshly Plucked Peacebloom - Silvermoon City
  {skillLineVariantID = 2906, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = 238538,       points = 3,  loc = {m = Enum.WK_Map.SilvermoonCity, x = 47.8, y = 51.6, hint = "A potion found on a bench."}},                                                                                                                                                                                                                                                                                                                    -- Pristine Potion Pristine Potion - Silvermoon City
  {skillLineVariantID = 2906, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = 238535,       points = 3,  loc = {m = Enum.WK_Map.ZulAman, x = 40.3, y = 51.1, hint = "A vial found on a cart."}},                                                                                                                                                                                                                                                                                                                              -- Vial of Zul'Aman Oddities Vial of Zul'Aman Oddities - Zul'Aman
  {skillLineVariantID = 2906, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = 238537,       points = 3,  loc = {m = Enum.WK_Map.AtalAman, x = 49.1, y = 23.5, hint = "A bowl found on a table."}},                                                                                                                                                                                                                                                                                                                            -- Measured Ladle Measured Ladle - Zul'Aman, Atal'Aman
  {skillLineVariantID = 2906, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = 238534,       points = 3,  loc = {m = Enum.WK_Map.Harandar, x = 34.7, y = 24.7, hint = "A vial found on the ground."}},                                                                                                                                                                                                                                                                                                                         -- Vial of Rootlands Oddities Vial of Rootlands Oddities - Harandar
  {skillLineVariantID = 2906, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = 238533,       points = 3,  loc = {m = Enum.WK_Map.SlayersRise, x = 41.8, y = 40.5, hint = "A vial on the ground next to some big bones."}},                                                                                                                                                                                                                                                                                                     -- Vial of Voidstorm Oddities Vial of Voidstorm Oddities - Voidstorm, Slayer's Rise
  {skillLineVariantID = 2906, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = 238532,       points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},                                                                                                                                                                                                                                                                                                                                            -- Vial of Eversong Oddities Vial of Eversong Oddities
  {skillLineVariantID = 2906, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = 238539,       points = 3,  loc = {m = Enum.WK_Map.Voidstorm, x = 32.7, y = 43.2, hint = "A small bottle on the ground."}},                                                                                                                                                                                                                                                                                                                      -- Failed Experiment Failed Experiment - Voidstorm
  {skillLineVariantID = 2906, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = 262645,       points = 10, loc = {m = Enum.WK_Map.Voidstorm, x = 52.6, y = 72.8, hint = "<Renown Quartermaster> Void Researcher Anomander"},                                                                                                                                   requires = {{type = "renown", id = Enum.WK_Faction.TheSingularity, amount = 9}, {type = "currency", id = Enum.WK_Currency.ArtisanAlchemistMoxie, amount = 75}}}, -- Beyond the Event Horizon: Alchemy
  ...
  {skillLineVariantID = 2906, categoryID = Enum.WK_ObjectiveCategory.Treatise,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 1},
  {skillLineVariantID = 2906, categoryID = Enum.WK_ObjectiveCategory.WeeklyQuest,   quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 2,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = "Complete a quest from the Artisan's Consortium."}},
  {skillLineVariantID = 2906, categoryID = Enum.WK_ObjectiveCategory.Treasure,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 2},
  {skillLineVariantID = 2906, categoryID = Enum.WK_ObjectiveCategory.Treasure,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 2},
  {skillLineVariantID = 2906, categoryID = Enum.WK_ObjectiveCategory.CatchUp,       quests = {},                                                                     itemID = MISSING_INFO, points = 0,  loc = {hint = "Awarded from Patron Orders at your crafting station."}},
  -- Midnight: Blacksmithing
  {skillLineVariantID = 2907, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2907, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2907, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2907, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2907, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  ...
  {skillLineVariantID = 2907, categoryID = Enum.WK_ObjectiveCategory.Treatise,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 1},
  {skillLineVariantID = 2907, categoryID = Enum.WK_ObjectiveCategory.WeeklyQuest,   quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 2,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = "Complete a quest from the Artisan's Consortium."}},
  {skillLineVariantID = 2907, categoryID = Enum.WK_ObjectiveCategory.Treasure,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 1},
  {skillLineVariantID = 2907, categoryID = Enum.WK_ObjectiveCategory.Treasure,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 1},
  {skillLineVariantID = 2907, categoryID = Enum.WK_ObjectiveCategory.CatchUp,       quests = {},                                                                     itemID = MISSING_INFO, points = 0,  loc = {hint = "Awarded from Patron Orders at your crafting station."}},
  -- Midnight: Enchanting
  {skillLineVariantID = 2909, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2909, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2909, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2909, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2909, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  ...
  {skillLineVariantID = 2909, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2909, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2909, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = 257600,       points = 10, loc = {m = Enum.WK_Map.EversongWoods, x = 43.4, y = 47.4, hint = "<Renown Quartermaster> Caeris Fairdawn"},                                                                                                                                         requires = {{type = "renown", id = Enum.WK_Faction.SilvermoonCity, amount = 6}, {type = "currency", id = Enum.WK_Currency.ArtisanEnchanterMoxie, amount = 75}}},          -- Skill Issue: Enchanting
  {skillLineVariantID = 2906, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = 250445,       points = 10, loc = {hint = ""},                                                                                                                                                                                                                                  requires = {{type = "currency", id = Enum.WK_Currency.UnalloyedAbundance, amount = 400}, {type = "currency", id = Enum.WK_Currency.ArtisanAlchemistMoxie, amount = 75}}}, -- Echo of Abundance: Enchanting
  ...
  {skillLineVariantID = 2909, categoryID = Enum.WK_ObjectiveCategory.Treatise,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 1},
  {skillLineVariantID = 2909, categoryID = Enum.WK_ObjectiveCategory.Treasure,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 1},
  {skillLineVariantID = 2909, categoryID = Enum.WK_ObjectiveCategory.Treasure,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 1},
  {skillLineVariantID = 2909, categoryID = Enum.WK_ObjectiveCategory.Gathering,     quests = {MISSING_INFO, MISSING_INFO, MISSING_INFO, MISSING_INFO, MISSING_INFO}, itemID = MISSING_INFO, points = 1,  loc = {hint = "These are randomly looted from disenchanting items."}},
  {skillLineVariantID = 2909, categoryID = Enum.WK_ObjectiveCategory.Gathering,     quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 4,  loc = {hint = "These are randomly looted from disenchanting items."}},
  {skillLineVariantID = 2909, categoryID = Enum.WK_ObjectiveCategory.WeeklyQuest,   quests = {MISSING_INFO, MISSING_INFO, MISSING_INFO},                             itemID = MISSING_INFO, points = 3,  limit = 1,                                                                                                                                                                                                                                          loc = {hint = "Complete a quest from your profession trainer."}},
  ...
  {skillLineVariantID = 2910, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2910, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2910, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2910, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2910, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  ...
  {skillLineVariantID = 2910, categoryID = Enum.WK_ObjectiveCategory.Treatise,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 1},
  {skillLineVariantID = 2910, categoryID = Enum.WK_ObjectiveCategory.WeeklyQuest,   quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 1,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = "Complete a quest from the Artisan's Consortium."}},
  {skillLineVariantID = 2910, categoryID = Enum.WK_ObjectiveCategory.Treasure,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 1},
  {skillLineVariantID = 2910, categoryID = Enum.WK_ObjectiveCategory.Treasure,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 1},
  {skillLineVariantID = 2910, categoryID = Enum.WK_ObjectiveCategory.CatchUp,       quests = {},                                                                     itemID = MISSING_INFO, points = 0,  loc = {hint = "Awarded from Patron Orders at your crafting station."}},
  -- Midnight: Herbalism
  {skillLineVariantID = 2912, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2912, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2912, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2912, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2912, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  ...
  {skillLineVariantID = 2912, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2912, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2912, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = 258410,       points = 10, loc = {m = Enum.WK_Map.Harandar, x = 51.0, y = 50.8, hint = "<Renown Quartermaster> Naynar"},                                                                                                                                                       requires = {{type = "renown", id = Enum.WK_Faction.Harati, amount = 6}, {type = "currency", id = Enum.WK_Currency.ArtisanHerbalistMoxie, amount = 75}}},                  -- Traditions of the Haranir: Herbalism
  {skillLineVariantID = 2906, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = 250443,       points = 10, loc = {hint = ""},                                                                                                                                                                                                                                  requires = {{type = "currency", id = Enum.WK_Currency.UnalloyedAbundance, amount = 400}, {type = "currency", id = Enum.WK_Currency.ArtisanHerbalistMoxie, amount = 75}}}, -- Echo of Abundance: Herbalism
  ...
  {skillLineVariantID = 2912, categoryID = Enum.WK_ObjectiveCategory.Treatise,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 1},
  {skillLineVariantID = 2912, categoryID = Enum.WK_ObjectiveCategory.Gathering,     quests = {MISSING_INFO, MISSING_INFO, MISSING_INFO, MISSING_INFO, MISSING_INFO}, itemID = MISSING_INFO, points = 1,  loc = {hint = "These are randomly looted from herbs around the world."}},
  {skillLineVariantID = 2912, categoryID = Enum.WK_ObjectiveCategory.Gathering,     quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 4,  loc = {hint = "These are randomly looted from herbs around the world."}},
  {skillLineVariantID = 2912, categoryID = Enum.WK_ObjectiveCategory.WeeklyQuest,   quests = {MISSING_INFO, MISSING_INFO, MISSING_INFO, MISSING_INFO, MISSING_INFO}, itemID = MISSING_INFO, points = 3,  limit = 1,                                                                                                                                                                                                                                          loc = {hint = "Complete a quest from your profession trainer."}},
  ...
  {skillLineVariantID = 2913, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2913, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2913, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2913, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2913, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  ...
  {skillLineVariantID = 2913, categoryID = Enum.WK_ObjectiveCategory.Treatise,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 1},
  {skillLineVariantID = 2913, categoryID = Enum.WK_ObjectiveCategory.WeeklyQuest,   quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 2,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = "Complete a quest from the Artisan's Consortium."}},
  {skillLineVariantID = 2913, categoryID = Enum.WK_ObjectiveCategory.Treasure,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 2},
  {skillLineVariantID = 2913, categoryID = Enum.WK_ObjectiveCategory.Treasure,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 2},
  {skillLineVariantID = 2913, categoryID = Enum.WK_ObjectiveCategory.CatchUp,       quests = {},                                                                     itemID = MISSING_INFO, points = 0,  loc = {hint = "Awarded from Patron Orders at your crafting station."}},
  -- Midnight: Jewelcrafting
  {skillLineVariantID = 2914, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2914, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2914, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2914, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2914, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  ...
  {skillLineVariantID = 2914, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2914, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2914, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = 257599,       points = 10, loc = {m = Enum.WK_Map.EversongWoods, x = 43.4, y = 47.4, hint = "<Renown Quartermaster> Caeris Fairdawn"},                                                                                                                                         requires = {{type = "renown", id = Enum.WK_Faction.SilvermoonCity, amount = 6}, {type = "currency", id = Enum.WK_Currency.ArtisanJewelcrafterMoxie, amount = 75}}}, -- Skill Issue: Jewelcrafting
  ...
  {skillLineVariantID = 2914, categoryID = Enum.WK_ObjectiveCategory.Treatise,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 1},
  {skillLineVariantID = 2914, categoryID = Enum.WK_ObjectiveCategory.WeeklyQuest,   quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 2,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = "Complete a quest from the Artisan's Consortium."}},
  {skillLineVariantID = 2914, categoryID = Enum.WK_ObjectiveCategory.Treasure,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 2},
  {skillLineVariantID = 2914, categoryID = Enum.WK_ObjectiveCategory.Treasure,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 2}, -- Deepstone Fragment
  {skillLineVariantID = 2914, categoryID = Enum.WK_ObjectiveCategory.CatchUp,       quests = {},                                                                     itemID = MISSING_INFO, points = 0,  loc = {hint = "Awarded from Patron Orders at your crafting station."}},
  -- Midnight: Leatherworking
  {skillLineVariantID = 2915, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2915, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2915, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2915, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2915, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  ...
  {skillLineVariantID = 2915, categoryID = Enum.WK_ObjectiveCategory.Treatise,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 1},
  {skillLineVariantID = 2915, categoryID = Enum.WK_ObjectiveCategory.WeeklyQuest,   quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 2,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = "Complete a quest from the Artisan's Consortium."}},
  {skillLineVariantID = 2915, categoryID = Enum.WK_ObjectiveCategory.Treasure,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 1},
  {skillLineVariantID = 2915, categoryID = Enum.WK_ObjectiveCategory.Treasure,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 1},
  {skillLineVariantID = 2915, categoryID = Enum.WK_ObjectiveCategory.CatchUp,       quests = {},                                                                     itemID = MISSING_INFO, points = 0,  loc = {hint = "Awarded from Patron Orders at your crafting station."}},
  -- Midnight: Mining
  {skillLineVariantID = 2916, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2916, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2916, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2916, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2916, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  ...
  {skillLineVariantID = 2906, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = 250444,       points = 10, loc = {hint = ""},                                                                                                                                                                                                                                  requires = {{type = "currency", id = Enum.WK_Currency.UnalloyedAbundance, amount = 400}, {type = "currency", id = Enum.WK_Currency.ArtisanMinerMoxie, amount = 75}}}, -- Echo of Abundance: Mining
  ...
  {skillLineVariantID = 2916, categoryID = Enum.WK_ObjectiveCategory.Treatise,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 1},
  {skillLineVariantID = 2916, categoryID = Enum.WK_ObjectiveCategory.Gathering,     quests = {MISSING_INFO, MISSING_INFO, MISSING_INFO, MISSING_INFO, MISSING_INFO}, itemID = MISSING_INFO, points = 1,  loc = {hint = "These are randomly looted from mining nodes around the world."}},
  {skillLineVariantID = 2916, categoryID = Enum.WK_ObjectiveCategory.Gathering,     quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {hint = "These are randomly looted from mining nodes around the world."}},
  {skillLineVariantID = 2916, categoryID = Enum.WK_ObjectiveCategory.WeeklyQuest,   quests = {MISSING_INFO, MISSING_INFO, MISSING_INFO, MISSING_INFO, MISSING_INFO}, itemID = MISSING_INFO, points = 3,  limit = 1,                                                                                                                                                                                                                                          loc = {hint = "Complete a quest from your profession trainer."}},
  ...
  {skillLineVariantID = 2917, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2917, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2917, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2917, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2917, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  ...
  {skillLineVariantID = 2917, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2917, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2917, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = 250923,       points = 10, loc = {m = Enum.WK_Map.ZulAman, x = 45.8, y = 65.8, hint = "<Renown Quartermaster> Magovu"},                                                                                                                                                        requires = {{type = "renown", id = Enum.WK_Faction.AmaniTribe, amount = 6}, {type = "currency", id = Enum.WK_Currency.ArtisanSkinnerMoxie, amount = 75}}},              -- Whisper of the Loa: Skinning
  {skillLineVariantID = 2906, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = 250360,       points = 10, loc = {hint = ""},                                                                                                                                                                                                                                  requires = {{type = "currency", id = Enum.WK_Currency.UnalloyedAbundance, amount = 400}, {type = "currency", id = Enum.WK_Currency.ArtisanSkinnerMoxie, amount = 75}}}, -- Echo of Abundance: Skinning
  ...
  {skillLineVariantID = 2917, categoryID = Enum.WK_ObjectiveCategory.Treatise,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 1},
  {skillLineVariantID = 2917, categoryID = Enum.WK_ObjectiveCategory.Gathering,     quests = {MISSING_INFO, MISSING_INFO, MISSING_INFO, MISSING_INFO, MISSING_INFO}, itemID = 224780,       points = 1,  loc = {hint = "These are randomly looted from skinning around the world."}},
  {skillLineVariantID = 2917, categoryID = Enum.WK_ObjectiveCategory.Gathering,     quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 2,  loc = {hint = "These are randomly looted from skinning around the world."}},
  {skillLineVariantID = 2917, categoryID = Enum.WK_ObjectiveCategory.WeeklyQuest,   quests = {MISSING_INFO, MISSING_INFO, MISSING_INFO, MISSING_INFO, MISSING_INFO}, itemID = MISSING_INFO, points = 3,  limit = 1,                                                                                                                                                                                                                                          loc = {hint = "Complete a quest from your profession trainer."}},
  ...
  -- Midnight: Tailoring
  {skillLineVariantID = 2918, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2918, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2918, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2918, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  {skillLineVariantID = 2918, categoryID = Enum.WK_ObjectiveCategory.Unique,        quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 3,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = ""}},
  ...
  {skillLineVariantID = 2918, categoryID = Enum.WK_ObjectiveCategory.Treatise,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 1},
  {skillLineVariantID = 2918, categoryID = Enum.WK_ObjectiveCategory.WeeklyQuest,   quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 2,  loc = {m = MISSING_INFO, x = MISSING_INFO, y = MISSING_INFO, hint = "Complete a quest from the Artisan's Consortium."}},
  {skillLineVariantID = 2918, categoryID = Enum.WK_ObjectiveCategory.Treasure,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 1},
  {skillLineVariantID = 2918, categoryID = Enum.WK_ObjectiveCategory.Treasure,      quests = {MISSING_INFO},                                                         itemID = MISSING_INFO, points = 1},
  {skillLineVariantID = 2918, categoryID = Enum.WK_ObjectiveCategory.CatchUp,       quests = {},                                                                     itemID = MISSING_INFO, points = 0,  loc = {hint = "Awarded from Patron Orders at your crafting station."}},
}
...
Data.SkillLineVariants = {
  ...
  {id = 2912, expansionID = Enum.ExpansionLevel.Midnight,     skillLineID = 182, name = "Midnight Herbalism",          catchUpCurrencyID = 3196, catchUpItemID = 0,},
  ...
  {id = 2915, expansionID = Enum.ExpansionLevel.Midnight,     skillLineID = 165, name = "Midnight Leatherworking",     catchUpCurrencyID = 3193, catchUpItemID = 2463320,},
  {id = 2916, expansionID = Enum.ExpansionLevel.Midnight,     skillLineID = 186, name = "Midnight Mining",             catchUpCurrencyID = 3192, catchUpItemID = 0,},
  {id = 2917, expansionID = Enum.ExpansionLevel.Midnight,     skillLineID = 393, name = "Midnight Skinning",           catchUpCurrencyID = 3191, catchUpItemID = 0,},
  {id = 2918, expansionID = Enum.ExpansionLevel.Midnight,     skillLineID = 197, name = "Midnight Tailoring",          catchUpCurrencyID = 3190, catchUpItemID = 0,},
}
