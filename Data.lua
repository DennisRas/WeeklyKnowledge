...
Data.Professions = {
  {
    ...
    objectives = {
      ...
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83058}, itemID = 224645, points = 10, loc = {m = 2339, x = 39.2, y = 24.2, hint = "This item can be purchased from the vendor Auditor Balwurz in Dornogal."},                              requires = {{type = "renown", id = 2590, amount = 12}, {type = "item", id = 210814, amount = 50}}}, -- Jewel-Etched Alchemy Notes
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83840}, itemID = 226265, points = 3,  loc = {m = 2339, x = 32.5, y = 60.5, hint = "This item is a keg behind the pillars next to the gate."}},                                                                                                                                                 -- Earthen Iron Powder
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83841}, itemID = 226266, points = 3,  loc = {m = 2248, x = 57.7, y = 61.8, hint = "This item is a metal frame found on top of a big chest."}},                                                                                                                                                 -- Metal Dornogal Frame
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83842}, itemID = 226267, points = 3,  loc = {m = 2214, x = 42.2, y = 24.1, hint = "This item is a bottle found on the table inside the building on the bottom floor."}},                                                                                                                       -- Reinforced Beaker
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83843}, itemID = 226268, points = 3,  loc = {m = 2214, x = 64.9, y = 61.8, hint = "This item is a rod found next to the forge inside the building on the bottom floor."}},                                                                                                                     -- Engraved Stirring Rod
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83844}, itemID = 226269, points = 3,  loc = {m = 2215, x = 42.6, y = 55.1, hint = "This item is a bottle found on the table near the fountain."}},                                                                                                                                             -- Chemist's Purified Water
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83845}, itemID = 226270, points = 3,  loc = {m = 2215, x = 41.7, y = 55.8, hint = "This item is a mortar found on the table inside the orphanage building."}},                                                                                                                                 -- Sanctified Mortar and Pestle
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83846}, itemID = 226271, points = 3,  loc = {m = 2213, x = 45.5, y = 13.3, hint = "This item is a bottle found on the desk inside the building."}},                                                                                                                                            -- Nerubian Mixing Salts
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83847}, itemID = 226272, points = 3,  loc = {m = 2255, x = 42.9, y = 57.3, hint = "This item is a vial found on the broken table in the building."}},                                                                                                                                          -- Dark Apothecary's Vial
      ...
      {objectiveID = Enum.WK_Objectives.Treasure,      quests = {83253}, itemID = 225234, points = 2,  loc = {hint = "These are randomly looted from treasures and dirt around the world."}},
      {objectiveID = Enum.WK_Objectives.Treasure,      quests = {83255}, itemID = 225235, points = 2,  loc = {hint = "These are randomly looted from treasures and dirt around the world."}},
  ...
  },
  {
    ...
    objectives = {
      ...
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83059}, itemID = 224647, points = 10, loc = {m = 2339, x = 39.2, y = 24.2, hint = "This item can be purchased from the vendor Auditor Balwurz in Dornogal."},                                                                                                      requires = {{type = "renown", id = 2590, amount = 12}, {type = "item", id = 210814, amount = 50}}}, -- Jewel-Etched Blacksmithing Notes
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83848}, itemID = 226276, points = 3,  loc = {m = 2248, x = 59.8, y = 61.9, hint = "This item is an anvil found inside the building."}},                                                                                                                                                                                                                                -- Ancient Earthen Anvil
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83849}, itemID = 226277, points = 3,  loc = {m = 2339, x = 47.7, y = 26.5, hint = "This item is a hammer found on a cube."}},                                                                                                                                                                                                                                          -- Dornogal Hammer
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83850}, itemID = 226278, points = 3,  loc = {m = 2214, x = 47.7, y = 33.2, hint = "This item is a hammer vise found next to the forge."}},                                                                                                                                                                                                                             -- Ringing Hammer Vise
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83851}, itemID = 226279, points = 3,  loc = {m = 2214, x = 60.5, y = 53.7, hint = "This item is a chisel found on the ground next to the forge."}},                                                                                                                                                                                                                    -- Earthen Chisels
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83852}, itemID = 226280, points = 3,  loc = {m = 2215, x = 47.6, y = 61.1, hint = "This item is an anvil found on the table."}},                                                                                                                                                                                                                                       -- Holy Flame Forge
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83853}, itemID = 226281, points = 3,  loc = {m = 2215, x = 44.0, y = 55.6, hint = "This item is a pair of tongs found on the table."}},                                                                                                                                                                                                                                -- Radiant Tongs
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83854}, itemID = 226282, points = 3,  loc = {m = 2213, x = 46.6, y = 22.7, hint = "This item is a crate found on the floor."}},                                                                                                                                                                                                                                        -- Nerubian Smith's Kit
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83855}, itemID = 226283, points = 3,  loc = {m = 2255, x = 53.0, y = 51.3, hint = "This item is a brush found on the table inside the building."}},                                                                                                                                                                                                                    -- Spiderling's Wire Brush
      ...
      {objectiveID = Enum.WK_Objectives.Treasure,      quests = {83256}, itemID = 225233, points = 1,  loc = {hint = "These are randomly looted from treasures and dirt around the world."}},
      {objectiveID = Enum.WK_Objectives.Treasure,      quests = {83257}, itemID = 225232, points = 1,  loc = {hint = "These are randomly looted from treasures and dirt around the world."}},
  ...
  },
  {
    ...
    objectives = {
      ...
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83060},                             itemID = 224652, points = 10, loc = {m = 2339, x = 39.2, y = 24.2, hint = "This item can be purchased from the vendor Auditor Balwurz in Dornogal."},                                     requires = {{type = "renown", id = 2590, amount = 12}, {type = "item", id = 210814, amount = 50}}}, -- Jewel-Etched Enchanting Notes
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83856},                             itemID = 226284, points = 3,  loc = {m = 2248, x = 57.6, y = 61.6, hint = "This item is a bottle found on a table."}},                                                                                                                                                                        -- Grinded Earthen Gem
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83859},                             itemID = 226285, points = 3,  loc = {m = 2339, x = 57.9, y = 56.9, hint = "This item is leaning against a wooden pillar next to Clerk Gretal."}},                                                                                                                                             -- Silver Dornogal Rod
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83860},                             itemID = 226286, points = 3,  loc = {m = 2214, x = 44.6, y = 22.2, hint = "This item is an orb found on the ground."}},                                                                                                                                                                       -- Soot-Coated Orb
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83861},                             itemID = 226287, points = 3,  loc = {m = 2214, x = 67.1, y = 65.9, hint = "This item is a bottle found on a table inside the building."}},                                                                                                                                                    -- Animated Enchanting Dust
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83862},                             itemID = 226288, points = 3,  loc = {m = 2215, x = 40.1, y = 70.5, hint = "This item is a candle found on a crate inside the building."}},                                                                                                                                                    -- Essence of Holy Fire
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83863},                             itemID = 226289, points = 3,  loc = {m = 2215, x = 48.6, y = 64.5, hint = "This item is a scroll found on a table inside the building."}},                                                                                                                                                    -- Enchanted Arathi Scroll
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83864},                             itemID = 226290, points = 3,  loc = {m = 2213, x = 61.6, y = 21.9, hint = "This item is a book found on a table."}},                                                                                                                                                                          -- Book of Dark Magic
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83865},                             itemID = 226291, points = 3,  loc = {m = 2255, x = 57.3, y = 44.1, hint = "This item is a purple shard found on the left table."}},                                                                                                                                                           -- Void Shard
      ...
      {objectiveID = Enum.WK_Objectives.Treasure,      quests = {83258},                             itemID = 225231, points = 1,  loc = {hint = "These are randomly looted from treasures and dirt around the world."}},
      {objectiveID = Enum.WK_Objectives.Treasure,      quests = {83259},                             itemID = 225230, points = 1,  loc = {hint = "These are randomly looted from treasures and dirt around the world."}},
      {objectiveID = Enum.WK_Objectives.Gathering,     quests = {84290, 84291, 84292, 84293, 84294}, itemID = 227659, points = 1,  loc = {hint = "These are randomly looted from disenchanting items."}},
      {objectiveID = Enum.WK_Objectives.Gathering,     quests = {84295},                             itemID = 227661, points = 4,  loc = {hint = "These are randomly looted from disenchanting items."}},
      {objectiveID = Enum.WK_Objectives.TrainerQuest,  quests = {84084, 84085, 84086},               itemID = 227667, points = 3,  limit = 1,                                                                                                                                                  loc = {m = 2339, x = 52.8, y = 71.2, hint = "Talk to your enchanting trainer |cff00ff00Nagad|r and complete the quest."}},
  ...
  },
  {
    ...
    objectives = {
      ...
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83866}, itemID = 226292, points = 3,  loc = {m = 2248, x = 61.3, y = 69.6, hint = "This item is a wrench found on the table in the building."}},                      -- Rock Engineer's Wrench
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83867}, itemID = 226293, points = 3,  loc = {m = 2339, x = 64.7, y = 52.7, hint = "This item can be found on the table behind Madam Goya."}},                         -- Dornogal Spectacles
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83868}, itemID = 226294, points = 3,  loc = {m = 2214, x = 42.6, y = 27.3, hint = "This item is a bomb on a crate next to the rails."}},                              -- Inert Mining Bomb
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83869}, itemID = 226295, points = 3,  loc = {m = 2214, x = 64.5, y = 58.8, hint = "This item is a scroll found on the floor behind the table inside the building."}}, -- Earthen Construct Blueprints
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83870}, itemID = 226296, points = 3,  loc = {m = 2215, x = 46.4, y = 61.5, hint = "This item is a bag found at the top of the stairs."}},                             -- Holy Firework Dud
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83871}, itemID = 226297, points = 3,  loc = {m = 2215, x = 41.6, y = 48.9, hint = "This item is a box found on the airship behind the dungeon entrance."}},           -- Arathi Safety Gloves
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83872}, itemID = 226298, points = 3,  loc = {m = 2255, x = 56.8, y = 38.7, hint = "This item is a mechanical spider found on the table at the back of the inn."}},    -- Puppeted Mechanical Spider
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83873}, itemID = 226299, points = 3,  loc = {m = 2213, x = 63.1, y = 11.5, hint = "This item is a canister found on the floor next to the harpoon."}},                -- Emptied Venom Canister
      ...
      {objectiveID = Enum.WK_Objectives.Treasure,      quests = {83260}, itemID = 225228, points = 1,  loc = {hint = "These are randomly looted from treasures and dirt around the world."}},
      {objectiveID = Enum.WK_Objectives.Treasure,      quests = {83261}, itemID = 225229, points = 1,  loc = {hint = "These are randomly looted from treasures and dirt around the world."}},
  ...
  },
  {
    ...
    objectives = {
      ...
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83066},                             itemID = 224656, points = 10, loc = {m = 2215, x = 42.4, y = 55.0, hint = "This item can be purchased from the vendor Auralia Steelstrike in Hallowfall."},                         requires = {{type = "renown", id = 2570, amount = 14}, {type = "item", id = 210814, amount = 50}}},
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83874},                             itemID = 226300, points = 3,  loc = {m = 2248, x = 57.6, y = 61.5, hint = "This item is a flower found in a bed of flowers."}},            -- Ancient Flower
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83875},                             itemID = 226301, points = 3,  loc = {m = 2339, x = 59.2, y = 23.7, hint = "This item is a scythe found at the bottom of the tree."}},      -- Dornogal Gardening Scythe
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83876},                             itemID = 226302, points = 3,  loc = {m = 2214, x = 48.3, y = 35.0, hint = "This item is a fork found on the table inside the building."}}, -- Earthen Digging Fork
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83877},                             itemID = 226303, points = 3,  loc = {m = 2214, x = 52.9, y = 65.8, hint = "This item is a knife found on the ground."}},                   -- Fungarian Slicer's Knife
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83878},                             itemID = 226304, points = 3,  loc = {m = 2215, x = 47.8, y = 63.3, hint = "This item is a trowel found on the ground."}},                  -- Arathi Garden Trowel
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83879},                             itemID = 226305, points = 3,  loc = {m = 2215, x = 35.9, y = 55.0, hint = "This item is a pair of tongs found next to the stairs."}},      -- Arathi Herb Pruner
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83880},                             itemID = 226306, points = 3,  loc = {m = 2213, x = 54.7, y = 20.8, hint = "This item is a flower found on the ground under the statue."}}, -- Web-Entangled Lotus
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83881},                             itemID = 226307, points = 3,  loc = {m = 2213, x = 46.7, y = 16.0, hint = "This item is a shovel found on the desk."}},                    -- Tunneler's Shovel
      ...
      {objectiveID = Enum.WK_Objectives.Gathering,     quests = {81416, 81417, 81418, 81419, 81420}, itemID = 224264, points = 1,  loc = {hint = "These are randomly looted from herbs around the world."}},
      {objectiveID = Enum.WK_Objectives.Gathering,     quests = {81421},                             itemID = 224265, points = 4,  loc = {hint = "These are randomly looted from herbs around the world."}},
      {objectiveID = Enum.WK_Objectives.TrainerQuest,  quests = {82970, 82958, 82965, 82916, 82962}, itemID = 224817, points = 3,  limit = 1,                                                                                                                                            loc = {m = 2339, x = 44.8, y = 69.4, hint = "Talk to your herbalism trainer |cff00ff00Akdan|r and complete the quest."}},
  ...
  },
  {
    ...
    objectives = {
      ...
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83882}, itemID = 226308, points = 3,  loc = {m = 2339, x = 57.2, y = 47.1, hint = "This item is a quill found on the shelf in the back of the auction house."}},      -- Dornogal Scribe's Quill
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83883}, itemID = 226309, points = 3,  loc = {m = 2248, x = 56.0, y = 60.1, hint = "This item is a pen found on the shelf in the building."}},                         -- Historian's Dip Pen
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83884}, itemID = 226310, points = 3,  loc = {m = 2214, x = 48.5, y = 34.2, hint = "This item is a scroll found on the table inside the building."}},                  -- Runic Scroll
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83885}, itemID = 226311, points = 3,  loc = {m = 2214, x = 62.5, y = 58.1, hint = "This item is a pot found on the table inside the building."}},                     -- Blue Earthen Pigment
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83886}, itemID = 226312, points = 3,  loc = {m = 2215, x = 43.2, y = 58.9, hint = "This item is a pen found on the table at the top of the stairs."}},                -- Informant's Fountain Pen
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83887}, itemID = 226313, points = 3,  loc = {m = 2215, x = 42.8, y = 49.1, hint = "This item is a chisel found on the table on the top floor inside the building."}}, -- Calligrapher's Chiseled Marker
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83888}, itemID = 226314, points = 3,  loc = {m = 2255, x = 55.9, y = 43.9, hint = "This item is a scroll found on the floor of the center main platform."}},          -- Nerubian Texts
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83889}, itemID = 226315, points = 3,  loc = {m = 2213, x = 50.1, y = 31.0, hint = "This item is an ink well found on the desk inside the building."}},                -- Venomancer's Ink Well
      ...
      {objectiveID = Enum.WK_Objectives.Treasure,      quests = {83262}, itemID = 225227, points = 2,  loc = {hint = "These are randomly looted from treasures and dirt around the world."}},
      {objectiveID = Enum.WK_Objectives.Treasure,      quests = {83264}, itemID = 225226, points = 2,  loc = {hint = "These are randomly looted from treasures and dirt around the world."}},
  ...
  },
  {
    ...
    objectives = {
      ...
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {82637}, itemID = 224054, points = 10, loc = {m = 2213, x = 47.6, y = 18.6, hint = "This item can be purchased from the vendor Alvus Valavulu in City of Threads."},                                   requires = {{type = "currency", id = 3056, amount = 565}}}, -- Emergent Crystals of the Surface-Dwellers
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83065}, itemID = 224655, points = 10, loc = {m = 2215, x = 42.4, y = 55.0, hint = "This item can be purchased from the vendor Auralia Steelstrike in Hallowfall."},                                   requires = {{type = "renown", id = 2570, amount = 14}, {type = "item", id = 210814, amount = 50}}},
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83890}, itemID = 226316, points = 3,  loc = {m = 2248, x = 63.5, y = 66.8, hint = "This item can be found in an object on the location below."}},
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83891}, itemID = 226317, points = 3,  loc = {m = 2339, x = 34.9, y = 52.3, hint = "This item can be found in an object on the location below."}},
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83892}, itemID = 226318, points = 3,  loc = {m = 2214, x = 48.5, y = 35.2, hint = "This item can be found in an object on the location below."}},
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83893}, itemID = 226319, points = 3,  loc = {m = 2214, x = 57.0, y = 54.6, hint = "This item can be found in an object on the location below."}},
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83894}, itemID = 226320, points = 3,  loc = {m = 2215, x = 47.5, y = 60.7, hint = "This item can be found in an object on the location below."}},
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83895}, itemID = 226321, points = 3,  loc = {m = 2215, x = 44.7, y = 50.9, hint = "This item can be found in an object on the location below."}},
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83896}, itemID = 226322, points = 3,  loc = {m = 2213, x = 47.7, y = 19.5, hint = "This item can be found in an object on the location below."}},
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83897}, itemID = 226323, points = 3,  loc = {m = 2255, x = 56.1, y = 58.7, hint = "This item can be found in an object on the location below."}},
      ...
      {objectiveID = Enum.WK_Objectives.Treasure,      quests = {83265}, itemID = 225224, points = 2,  loc = {hint = "These are randomly looted from treasures and dirt around the world."}},
      {objectiveID = Enum.WK_Objectives.Treasure,      quests = {83266}, itemID = 225225, points = 2,  loc = {hint = "These are randomly looted from treasures and dirt around the world."}}, -- Deepstone Fragment
  ...
  },
  {
    ...
    objectives = {
      ...
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83068}, itemID = 224658, points = 10, loc = {m = 2215, x = 42.4, y = 55.0, hint = "This item can be purchased from the vendor Auralia Steelstrike in Hallowfall."},                           requires = {{type = "renown", id = 2570, amount = 14}, {type = "item", id = 210814, amount = 50}}},
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83898}, itemID = 226324, points = 3,  loc = {m = 2339, x = 68.1, y = 23.3, hint = "This item is a tool found on the rack inside the building."}},           -- Earthen Lacing Tools
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83899}, itemID = 226325, points = 3,  loc = {m = 2248, x = 58.7, y = 30.7, hint = "This item is a knife found on a hay bale inside the building."}},        -- Dornogal Craftman's Flat Knife
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83900}, itemID = 226326, points = 3,  loc = {m = 2214, x = 47.1, y = 34.8, hint = "This item is a bottle found on the shelf inside the building."}},        -- Underground Stropping Compound
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83901}, itemID = 226327, points = 3,  loc = {m = 2214, x = 64.3, y = 65.2, hint = "This item is a tool found on the table inside the building."}},          -- Earthen Awl
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83902}, itemID = 226328, points = 3,  loc = {m = 2215, x = 47.5, y = 65.1, hint = "This item is a pair of tongs found on the table inside the building."}}, -- Arathi Beveler Set
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83903}, itemID = 226329, points = 3,  loc = {m = 2215, x = 41.5, y = 57.8, hint = "This item is a tool found on a barrel."}},                               -- Arathi Leather Burnisher
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83904}, itemID = 226330, points = 3,  loc = {m = 2213, x = 55.2, y = 26.8, hint = "This item is a mallet found on the table inside the building."}},        -- Nerubian Tanning Mallet
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83905}, itemID = 226331, points = 3,  loc = {m = 2255, x = 60.0, y = 53.9, hint = "This item is a knife found on the desk."}},                              -- Curved Nerubian Skinning Knife
  ...
  },
  {
    ...
    objectives = {
      ...
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83906},                             itemID = 226332, points = 3,  loc = {m = 2248, x = 58.2, y = 62.0, hint = "This item is a gavel found on the table."}},                               -- Earthen Miner's Gavel
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83907},                             itemID = 226333, points = 3,  loc = {m = 2339, x = 36.6, y = 79.3, hint = "This item is a chisel found on the crystal statue."}},                     -- Dornogal Chisel
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83908},                             itemID = 226334, points = 3,  loc = {m = 2214, x = 49.5, y = 27.5, hint = "This item is a shovel found on the ground."}},                             -- Earthen Excavator's Shovel
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83909},                             itemID = 226335, points = 3,  loc = {m = 2214, x = 66.3, y = 66.2, hint = "This item is ore found on the ground."}},                                  -- Regenerating Ore
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83910},                             itemID = 226336, points = 3,  loc = {m = 2215, x = 46.1, y = 64.5, hint = "This item is a drill found on the table under the building."}},            -- Arathi Precision Drill
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83911},                             itemID = 226337, points = 3,  loc = {m = 2215, x = 43.1, y = 56.8, hint = "This item is a tool found on the table behind the mining trainer."}},      -- Devout Archaeologist's Excavator
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83912},                             itemID = 226338, points = 3,  loc = {m = 2213, x = 46.8, y = 21.4, hint = "This item is a crusher found on the desk near the forge."}},               -- Heavy Spider Crusher
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83913},                             itemID = 226339, points = 3,  loc = {m = 2213, x = 48.1, y = 40.7, hint = "This item is a cart found on the ground between the flowers and roots."}}, -- Nerubian Mining Supplies
      ...
      {objectiveID = Enum.WK_Objectives.Gathering,     quests = {83050, 83051, 83052, 83053, 83054}, itemID = 224583, points = 1,  loc = {hint = "These are randomly looted from mining nodes around the world."}},
      {objectiveID = Enum.WK_Objectives.Gathering,     quests = {83049},                             itemID = 224584, points = 3,  loc = {hint = "These are randomly looted from mining nodes around the world."}},
      {objectiveID = Enum.WK_Objectives.TrainerQuest,  quests = {83104, 83105, 83103, 83106, 83102}, itemID = 224818, points = 3,  limit = 1,                                                                                                                                                loc = {m = 2339, x = 52.6, y = 52.6, hint = "Talk to your mining trainer |cff00ff00Tarib|r and complete the quest."}},
  ...
  },
  {
    ...
    objectives = {
      ...
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83067},                             itemID = 224657, points = 10, loc = {m = 2215, x = 42.4, y = 55.0, hint = "This item can be purchased from the vendor Auralia Steelstrike in Hallowfall."},                   requires = {{type = "renown", id = 2570, amount = 14}, {type = "item", id = 210814, amount = 50}}},
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83914},                             itemID = 226340, points = 3,  loc = {m = 2339, x = 28.7, y = 51.8, hint = "This item can be found in an object on the location below."}},
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83915},                             itemID = 226341, points = 3,  loc = {m = 2248, x = 60.0, y = 28.0, hint = "This item can be found in an object on the location below."}},
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83916},                             itemID = 226342, points = 3,  loc = {m = 2214, x = 47.3, y = 28.4, hint = "This item can be found in an object on the location below."}},
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83917},                             itemID = 226343, points = 3,  loc = {m = 2214, x = 65.8, y = 61.9, hint = "This item can be found in an object on the location below."}},
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83918},                             itemID = 226344, points = 3,  loc = {m = 2215, x = 49.3, y = 62.1, hint = "This item can be found in an object on the location below."}},
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83919},                             itemID = 226345, points = 3,  loc = {m = 2215, x = 42.3, y = 53.9, hint = "This item can be found in an object on the location below."}},
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83920},                             itemID = 226346, points = 3,  loc = {m = 2213, x = 44.6, y = 49.3, hint = "This item can be found in an object on the location below."}},
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83921},                             itemID = 226347, points = 3,  loc = {m = 2255, x = 56.5, y = 55.2, hint = "This item can be found in an object on the location below."}},
      ...
      {objectiveID = Enum.WK_Objectives.Gathering,     quests = {81459, 81460, 81461, 81462, 81463}, itemID = 224780, points = 1,  loc = {hint = "These are randomly looted from skinning around the world."}},
      {objectiveID = Enum.WK_Objectives.Gathering,     quests = {81464},                             itemID = 224781, points = 2,  loc = {hint = "These are randomly looted from skinning around the world."}},
      {objectiveID = Enum.WK_Objectives.TrainerQuest,  quests = {83097, 83098, 83100, 82992, 82993}, itemID = 224807, points = 3,  limit = 1,                                                                                                                                      loc = {m = 2339, x = 54.4, y = 57.6, hint = "Talk to your skinning trainer |cff00ff00Ginnad|r and complete the quest."}},
  ...
  },
  {
    ...
    objectives = {
      ...
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83061}, itemID = 224648, points = 10, loc = {m = 2339, x = 39.2, y = 24.2, hint = "This item can be purchased from the vendor Auditor Balwurz in Dornogal."},                                                 requires = {{type = "renown", id = 2590, amount = 12}, {type = "item", id = 210814, amount = 50}}}, -- Jewel-Etched Tailoring Notes
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83922}, itemID = 226348, points = 3,  loc = {m = 2339, x = 61.5, y = 18.7, hint = "This item is a knife found on the table in the back of the building."}},                                                                                                                                                       -- Dornogal Seam Ripper
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83923}, itemID = 226349, points = 3,  loc = {m = 2248, x = 56.2, y = 61.0, hint = "This item is a tape measure found on the table."}},                                                                                                                                                                            -- Earthen Tape Measure
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83924}, itemID = 226350, points = 3,  loc = {m = 2214, x = 48.9, y = 32.8, hint = "This item is a pin found on the shelf in the back right room of the inn."}},                                                                                                                                                   -- Runed Earthen Pins
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83925}, itemID = 226351, points = 3,  loc = {m = 2214, x = 64.2, y = 60.3, hint = "This item is a pair of scisssors found on the table."}},                                                                                                                                                                       -- Earthen Sticher's Snips
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83926}, itemID = 226352, points = 3,  loc = {m = 2215, x = 49.3, y = 62.3, hint = "This item is a cutter found on the table."}},                                                                                                                                                                                  -- Arathi Rotary Cutter
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83927}, itemID = 226353, points = 3,  loc = {m = 2215, x = 40.1, y = 68.1, hint = "This item is a protractor found on a crate inside the building."}},                                                                                                                                                            -- Royal Outfitter's Protractor
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83928}, itemID = 226354, points = 3,  loc = {m = 2255, x = 53.3, y = 53.0, hint = "This item is a quilt found inside the building to the left."}},                                                                                                                                                                -- Nerubian Quilt
      {objectiveID = Enum.WK_Objectives.Unique,        quests = {83929}, itemID = 226355, points = 3,  loc = {m = 2213, x = 50.5, y = 16.7, hint = "This item is a pincushian found on the desk."}},                                                                                                                                                                               -- Nerubian's Pincushion
      ...
      {objectiveID = Enum.WK_Objectives.Treasure,      quests = {83269}, itemID = 225221, points = 1,  loc = {hint = "These are randomly looted from treasures and dirt around the world."}},
      {objectiveID = Enum.WK_Objectives.Treasure,      quests = {83270}, itemID = 225220, points = 1,  loc = {hint = "These are randomly looted from treasures and dirt around the world."}},
