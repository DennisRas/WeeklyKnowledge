...
local objectives = {
  ...
  -- Midnight: Alchemy
  {skillLineVariantID = 2906, categoryID = category, quests = {29506}, itemID = 0, points = 3, loc = {m = Enum.WK_Map.DarkmoonIsland, x = 50.2, y = 69.6, hint = "Talk to |cff00ff00Sylannia|r at the Darkmoon Faire and complete the quest |cffffff00A Fizzy Fusion|r."},                                                                         requires = {{type = "item", id = 1645, amount = 5}}},                                                                                  -- Darkmoon Faire
  ...
  -- Midnight: Enchanting
  {skillLineVariantID = 2909, categoryID = category, quests = {29510}, itemID = 0, points = 3, loc = {m = Enum.WK_Map.DarkmoonIsland, x = 53.2, y = 76.6, hint = "Talk to |cff00ff00Sayge|r at the Darkmoon Faire and complete the quest |cffffff00Putting Trash to Good Use|r."}},                                                                                                                                                                                                       -- Darkmoon Faire
  -- Midnight: Engineering
  {skillLineVariantID = 2910, categoryID = category, quests = {29511}, itemID = 0, points = 3, loc = {m = Enum.WK_Map.DarkmoonIsland, x = 49.6, y = 60.8, hint = "Talk to |cff00ff00Rinling|r at the Darkmoon Faire and complete the quest |cffffff00Talkin' Tonks|r."}},                                                                                                                                                                                                                 -- Darkmoon Faire
  -- Midnight: Herbalism
  {skillLineVariantID = 2912, categoryID = category, quests = {29514}, itemID = 0, points = 3, loc = {m = Enum.WK_Map.DarkmoonIsland, x = 55.0, y = 70.6, hint = "Talk to |cff00ff00Chronos|r at the Darkmoon Faire and complete the quest |cffffff00Herbs for Healing|r."}},                                                                                                                                                                                                             -- Darkmoon Faire
  -- Midnight: Inscription
  {skillLineVariantID = 2913, categoryID = category, quests = {29515}, itemID = 0, points = 3, loc = {m = Enum.WK_Map.DarkmoonIsland, x = 53.2, y = 76.6, hint = "Talk to |cff00ff00Sayge|r at the Darkmoon Faire and complete the quest |cffffff00Writing the Future|r"},                                                                         requires = {{type = "item", id = 39354, amount = 5}}},                                                                                 -- Darkmoon Faire
  -- Midnight: Jewelcrafting
  {skillLineVariantID = 2914, categoryID = category, quests = {29516}, itemID = 0, points = 3, loc = {m = Enum.WK_Map.DarkmoonIsland, x = 55.0, y = 70.6, hint = "Talk to |cff00ff00Chronos|r at the Darkmoon Faire and complete the quest |cffffff00Keeping the Faire Sparkling|r."}},                                                                                                                                                                                                   -- Darkmoon Faire
  -- Midnight: Leatherworking
  {skillLineVariantID = 2915, categoryID = category, quests = {29517}, itemID = 0, points = 3, loc = {m = Enum.WK_Map.DarkmoonIsland, x = 49.6, y = 60.8, hint = "Talk to |cff00ff00Rinling|r at the Darkmoon Faire and complete the quest |cffffff00Eyes on the Prizes|r."},                                                                      requires = {{type = "item", id = 6529, amount = 10}, {type = "item", id = 2320, amount = 5}, {type = "item", id = 6260, amount = 5}}}, -- Darkmoon Faire
  -- Midnight: Mining
  {skillLineVariantID = 2916, categoryID = category, quests = {29518}, itemID = 0, points = 3, loc = {m = Enum.WK_Map.DarkmoonIsland, x = 49.6, y = 60.8, hint = "Talk to |cff00ff00Rinling|r at the Darkmoon Faire and complete the quest |cffffff00Rearm, Reuse, Recycle|r."}},                                                                                                                                                                                                         -- Darkmoon Faire
  -- Midnight: Skinning
  {skillLineVariantID = 2917, categoryID = category, quests = {29519}, itemID = 0, points = 3, loc = {m = Enum.WK_Map.DarkmoonIsland, x = 55.0, y = 70.6, hint = "Talk to |cff00ff00Chronos|r at the Darkmoon Faire and complete the quest |cffffff00Tan My Hide|r."}},                                                                                                                                                                                                                   -- Darkmoon Faire
  -- Midnight: Tailoring
