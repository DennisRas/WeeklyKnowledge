...
local objectives = {
  ...
  {skillLineVariantID = 2877, categoryID = category, quests = {82970, 82958, 82965, 82916, 82962}, itemID = 224817, points = 3, limit = 1,                                                                                                                      loc = {m = Enum.WK_Map.Dornogal, x = 44.8, y = 69.4, hint = "Talk to your profession trainer and complete the quest."}},
  ...
  {skillLineVariantID = 2881, categoryID = category, quests = {83104, 83105, 83103, 83106, 83102}, itemID = 224818, points = 3, limit = 1,                                                                                                                      loc = {m = Enum.WK_Map.Dornogal, x = 52.6, y = 52.6, hint = "Talk to your profession trainer and complete the quest."}},
  -- The War Within: Skinning
  {skillLineVariantID = 2882, categoryID = category, quests = {83097, 83098, 83100, 82992, 82993}, itemID = 224807, points = 3, limit = 1,                                                                                                                      loc = {m = Enum.WK_Map.Dornogal, x = 54.4, y = 57.6, hint = "Talk to your profession trainer and complete the quest."}},
  ...
  -- Midnight: Enchanting
  {skillLineVariantID = 2909, categoryID = category, quests = {93699, 93698},                      itemID = 263464, points = 3, limit = 1,                                                                                                                      loc = {m = Enum.WK_Map.SilvermoonCity, x = 47.8, y = 53.8, hint = "Complete a quest from |cffffff00Dolothos|r <Enchanting Trainer>."}},
  ...
  -- Midnight: Herbalism
  {skillLineVariantID = 2912, categoryID = category, quests = {93704, 93703, 93702, 93700},        itemID = 263462, points = 3, limit = 1,                                                                                                                      loc = {m = Enum.WK_Map.SilvermoonCity, x = 48.2, y = 51.6, hint = "Complete a quest from |cffffff00Botanist Nathera|r <Herbalism Trainer>."}},
  ...
  -- Midnight: Mining
  {skillLineVariantID = 2916, categoryID = category, quests = {93709, 93708, 93706, 93705},        itemID = 263463, points = 3, limit = 1,                                                                                                                      loc = {m = Enum.WK_Map.SilvermoonCity, x = 42.6, y = 52.8, hint = "Complete a quest from |cffffff00Belil|r <Mining Trainer>."}},
  -- Midnight: Skinning
  {skillLineVariantID = 2917, categoryID = category, quests = {93714, 93711, 93710},               itemID = 263461, points = 3, limit = 1,                                                                                                                      loc = {m = Enum.WK_Map.SilvermoonCity, x = 43.2, y = 55.6, hint = "Complete a quest from |cffffff00Tyn|r <Skinning Trainer>."}},
  -- Midnight: Tailoring
